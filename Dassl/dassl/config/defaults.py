...
_C.OPTIMGATING = CN()
_C.OPTIMGATING.NAME = "adam"
_C.OPTIMGATING.LR = 0.0003
_C.OPTIMGATING.WEIGHT_DECAY = 5e-4
_C.OPTIMGATING.MOMENTUM = 0.9
_C.OPTIMGATING.SGD_DAMPNING = 0
_C.OPTIMGATING.SGD_NESTEROV = False
_C.OPTIMGATING.RMSPROP_ALPHA = 0.99
# The following also apply to other
# adaptive optimizers like adamw
_C.OPTIMGATING.ADAM_BETA1 = 0.9
_C.OPTIMGATING.ADAM_BETA2 = 0.999
# STAGED_LR allows different layers to have
# different lr, e.g. pre-trained base layers
# can be assigned a smaller lr than the new
# classification layer
_C.OPTIMGATING.STAGED_LR = False
_C.OPTIMGATING.NEW_LAYERS = ()
_C.OPTIMGATING.BASE_LR_MULT = 0.1
# Learning rate scheduler
_C.OPTIMGATING.LR_SCHEDULER = "single_step"
# # -1 or 0 means the stepsize is equal to max_epoch
# _C.OPTIMGATING.STEPSIZE = (-1, )
# _C.OPTIMGATING.GAMMA = 0.1
_C.OPTIMGATING.MAX_EPOCH = 1
# Set WARMUP_EPOCH larger than 0 to activate warmup training
_C.OPTIMGATING.WARMUP_EPOCH = -1
# Either linear or constant
_C.OPTIMGATING.WARMUP_TYPE = "linear"
# Constant learning rate when type=constant
_C.OPTIMGATING.WARMUP_CONS_LR = 1e-5
# Minimum learning rate when type=linear
_C.OPTIMGATING.WARMUP_MIN_LR = 1e-5
# Recount epoch for the next scheduler (last_epoch=-1)
# Otherwise last_epoch=warmup_epoch
_C.OPTIMGATING.WARMUP_RECOUNT = True
